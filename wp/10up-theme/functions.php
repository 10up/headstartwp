 ...
 *
 * Generated by every build. Inert unless `npm run dev` is actually running --
 * while it is, it rewrites the URL of every script and stylesheet enqueued out
 * of dist/ to the dev server and adds the HMR client. No registration code
 * needs to change.
 */
if ( file_exists( __DIR__ . '/dist/dev-server.php' ) ) {
	require_once __DIR__ . '/dist/dev-server.php';
}
