...
For more details on the available filters to customize block styles processing, see the [Core Block CSS Loading Filters](/learn/app-router/wordpress-integration/gutenberg#core-block-css-loading-filters) section.
