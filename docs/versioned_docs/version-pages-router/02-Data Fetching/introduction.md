...
The data-fetching logic itself is abstracted by [strategies](/api/@headstartwp/core/classes/AbstractFetchStrategy/). The custom React hooks are powered by [useSwr](https://swr.vercel.app/).
