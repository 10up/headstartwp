...
> The [useSearchNative](/api/@headstartwp/next/#usesearchnative) hook is the Next.js binding for the [useFetchSearchNative](/api/@headstartwp/core/namespaces/react/#usefetchsearchnative).
