...
- f422387: [#305](https://github.com/10up/headless/issues/305)]. Fix post path mapping for custom post types.
...
- 5c4dc9b: [#304](https://github.com/10up/headless/pull/304) fix: post path mapping for ut8encoded slugs.
